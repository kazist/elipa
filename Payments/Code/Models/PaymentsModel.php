...
namespace Elipa\Payments\Code\Models;
...
class PaymentsModel extends BasePaymentsModel {
    ...
    public function processElipa($payment_id) {

        $email = new Email();

        $posted_data = $this->getElipaParams($payment_id);
    ...
    private function getElipaParams($payment_id) {
        ...
        $factory->saveRecordByEntity('#__elipa_payments', $posted_data, array('ip.txncd=:txncd'), array('txncd' => $posted_data['txncd']));
